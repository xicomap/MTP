...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            @if ($type == 1)
            <a href="{{ route('admin.metec.create') }}" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New</a>
            @endif
            
            <form class="form-horizontal" action="{{route('admin.metec.index')}}" method="GET" role="form">
			{{csrf_field()}}
                ...
                <tbody>
                    ...
                    <tr>                         	   	
                        ...
                        <td> 
                             ...
                             <form action="{{ route('admin.metec.destroy', $idea->id) }}" method="POST">
                                {{ csrf_field() }}
                                <input type="hidden" name="_method" value="DELETE">
                                  <a href="{{ route('admin.metec.edit', $idea->id) }}" class="btn btn-info"><i class="fa fa-pencil"></i> @lang('admin.edit')</a>
                                 @if($idea->type == 1)             
