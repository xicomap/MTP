...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.rule.store')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}            	
				
            	<div class="form-group row">
					<label for="first_name" class="col-xs-12 col-form-label">Branch Name</label>
					<div class="col-xs-10">
						{!! dropdown('branch_name',$branch) !!}
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-xs-10">
                                ...
                                {!! dropdown('department_name',$department) !!}
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('article_number') }}" name="article_number" required id="article_number" placeholder="Article Number">
					</div>
				</div>
				<div class="form-group row">
