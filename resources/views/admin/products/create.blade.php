    	...
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.product.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('title') }}" name="title" required id="title" placeholder="Product Name">
					</div>
				</div>
				...
				<div class="form-group row" style="display:none">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('url') }}" name="url"  id="url" placeholder="Product URL">
					</div>
				</div>
