...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
    	    <a href="{{ route('admin.metec.index') }}?type={{$mp->type}}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> @lang('admin.back')</a>

			<h5 style="margin-bottom: 2em;">{{$heading}}</h5>

                 <form class="form-horizontal" action="{{route('admin.metec.update', $mp->id )}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
            	...
            	<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ $mp->metec_id }}" name="metec_id" required id="metec_id" placeholder="METEC ID">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="{{route('admin.metec.index')}}?type={{$mp->type}}" class="btn btn-default">@lang('admin.cancel')</a>
					</div>
				</div>
			</form>
		</div>
