...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;">New Posts</h5>

            <form class="form-horizontal" action="{{route('admin.mlt.store')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}      
            	
            	<div class="form-group row">
					<label for="first_name" class="col-xs-12 col-form-label">Mlt ID</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" name="mlt_id" required id="mlt_id" placeholder="MLT ID">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="{{route('admin.mlt.index')}}?type=1" class="btn btn-default">@lang('admin.cancel')</a>
					</div>
				</div>
			</form>
		</div>
