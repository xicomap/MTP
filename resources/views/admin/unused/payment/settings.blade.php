                ...
                <div class="card card-block card-inverse card-primary">
                    <blockquote class="card-blockquote">
                        ...
                        <div id="card_field" @if(Setting::get('CARD') == 0) style="display: none;" @endif>
                            ...
                            <div class="form-group row">
                                <label for="stripe_client_id" class="col-xs-4 col-form-label">Stripe Client Id</label>
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="{{Setting::get('stripe_client_id', '') }}" name="stripe_client_id" id="stripe_client_id"  placeholder="Stripe Client Id">
                                </div>
                            </div>
                        </div>
                    </blockquote>
